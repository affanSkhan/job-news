  ...
  return (
    <main className="container section">
      <div className="card" style={{maxWidth:860,margin:"0 auto"}}>
        <div className="eyebrow">JobNews Radar</div>
        <h1>A signal layer for the job market.</h1>
        <p>JobNews Radar continuously discovers public opportunities, validates employer or ATS application paths, removes duplicates and stale listings, then uses AI to make the remaining market easier to search and match.</p>
